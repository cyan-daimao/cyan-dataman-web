...
import { listEmployees, EmployeeDTO as EmployeeAPIDTO } from "../../../api/EmployeeApi.ts";
  ...
  const handleSubmit = async () => {
    try {
      ...
      const tableValObj = {
        ...
        name: `${formValues.layerCode.toLowerCase()}_${formValues.subjectCode}_${formValues.name}`,
      ...
      const cmd = {
        ...
        comment: formValues.comment,
        heatLevel: formValues.secretLevel,
